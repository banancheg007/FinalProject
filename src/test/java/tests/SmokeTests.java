...
public class SmokeTests extends BaseTest{
    ...
    public void CheckSendingConnectRequestWithWrongTelephone(String surname, String name, String telephone, String address, String message, String expectedText){
